...
const allPosts = computed(() => {
  ...
  console.log('MyTopics.vue - Вычисляем allPosts:', {
...
const fetchPosts = async () => {
  ...
  try {
    ...
    store.dispatch('pagination/setTotalItems', fetchedPosts.length);
  } catch (error) {
...
watch(allPosts, (newValue, oldValue) => {
  console.log('MyTopics.vue - Обнаружено изменение в allPosts:', {
